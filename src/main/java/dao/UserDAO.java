...
public class UserDAO {
    ...
    public boolean isAccountLocked(String username) {
        ...
        try(Connection connection=DBConnection.getConnection();PreparedStatement statement=connection.prepareStatement(sql)) {
            ...
            System.out.println("Error while checking account lock");
            System.out.println(e.getMessage());
        }
        return false;
    }
    public void recordFailedLogin(String username) {
        ...
        try(Connection connection=DBConnection.getConnection();PreparedStatement statement=connection.prepareStatement(sql)) {
            ...
            System.out.println("Error while recording failed login");
            System.out.println(e.getMessage());
        }
    }
    public void clearLoginAttempts(String username) {
        ...
        try(Connection connection=DBConnection.getConnection();PreparedStatement statement=connection.prepareStatement(sql)) {
            ...
            System.out.println("Error while clearing login attempts");
            System.out.println(e.getMessage());
        }
    }
    public int getFailedLoginAttempts(String username) {
        ...
        try(Connection connection=DBConnection.getConnection();PreparedStatement statement=connection.prepareStatement(sql)) {
            ...
            System.out.println("Error while getting failed login attempts");
            System.out.println(e.getMessage());
        }
        return 0;
    }
