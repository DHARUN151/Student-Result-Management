...
public class AddMarksServlet extends HttpServlet {
    protected void doGet(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException {
        ...
        List<Map<String,Object>> offerings=service.getAssignedOfferings(userId);
        List<Map<String,Object>> students=service.getAssignedStudents(userId);
    ...
    protected void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException {
        ...
        try {
            ...
            boolean success=service.addMarks(marks,studentId,offeringId,examId,userId);
            if(success)
                response.sendRedirect("AddMarksServlet?success=true&total="+marks.getTotalMark()+"&grade="+marks.getGrade()+"&status="+marks.getStatus());
            else
